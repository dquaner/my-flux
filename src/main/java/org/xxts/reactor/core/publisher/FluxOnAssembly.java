...
final class FluxOnAssembly<T> extends InternalFluxOperator<T, T> implements Fuseable,
	...
	/**
	 * Create an assembly trace decorated as a {@link reactor.core.publisher.Flux}.
	 */
	FluxOnAssembly(reactor.core.publisher.Flux<? extends T> source, AssemblySnapshot snapshotStack) {
		super(source);
